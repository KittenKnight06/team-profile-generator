const Manager = require("./positions/Manager.js");
const Engineer = require("./positions/Engineer.js");
const Intern = require("./positions/Intern.js");
...
function runApp () {
  ...
  function createTeam () {
    inquirer.prompt([{
      ...
      choices: ["Manager", "Engineer", "Intern", "No more team members to be added."]
